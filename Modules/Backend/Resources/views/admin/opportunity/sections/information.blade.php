                ...
                <div class="col-md-6">
                    @include('cms::components.inputs.select', [
                        'options' => [
                            'id'                => 'stats',
                            'name'              => 'stats',
                            'label'             => __('backend::opportunity.fields.stats.label'),
                            'placeholder'       => __('backend::opportunity.fields.stats.placeholder'),
                            'help'              => __('backend::opportunity.fields.stats.help'),
                            'selected'          => [],
                            'required'          => true,
                            'multiple'          => true,
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="form-group form-group-last row">
                        <span class="col-form-label col-lg-12 col-sm-12"> {{ __('backend::opportunity.fields.tags.label')}}</span>
                        <div class="col-lg-12 col-md-12 col-sm-12">
                            <input id="kt_tagify_1" name='tags' placeholder='{{__('backend::opportunity.fields.tags.placeholder')}}' value='' autofocus data-blacklist=''>

                            <div class="kt-margin-t-10">
                                <a href="javascript:;" style="    float: left;" id="kt_tagify_1_remove" class="btn btn-label-brand btn-bold"> {{ __('backend::opportunity.fields.tags.delet')}}</a>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-12">
                    @include('cms::components.inputs.textarea', [
                        'options' => [
                            ...
                            'name'              => 'keys',
                            'type'              => 'text',
                            'label'             => __('backend::opportunity.fields.keys.label'),
                            'placeholder'       => __('backend::opportunity.fields.keys.placeholder'),
                            'help'              => __('backend::opportunity.fields.keys.help'),
                            'value'             => old('keys'),
                            'required'          => true,
                            'inline'            => false,
                            'maxlength'         => 20,
