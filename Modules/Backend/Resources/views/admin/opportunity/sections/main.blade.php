                                                ...
                                                <div class="col-md-6">
                                                    @include('cms::components.inputs.image', [
                                                        'options' => [
                                                            ...
                                                            'required'      => false,
                                                            // 'inline'        => '3:9',
                                                            'browse'        => __('backend::projects.fields.opportunity_image1.add_text'),
                                                            'remove'        => __('backend::projects.fields.opportunity_image1.remove_text'),
                                                            'width'         => '349px',
                                                            'height'        => '250px',
                                                        ]
                                                    ])
                                                ...
                                                <div class="col-md-6">
                                                    @include('cms::components.inputs.text', [
                                                        'options' => [
                                                            ...
                                                            'name'              => 'video2_'.$locale,
                                                            'type'              => 'text',
                                                            'label'             => __('backend::opportunity.fields.video2.label'),
                                                            'placeholder'       => __('backend::opportunity.fields.video2.placeholder'),
                                                            'help'              => __('backend::opportunity.fields.video2.help'),
                                                ...
                                                <div class="col-md-6">
                                                    @include('cms::components.inputs.image', [
                                                        'options' => [
                                                            ...
                                                            'type'          => 'text',
                                                            'label'         => __('backend::projects.fields.opportunity_image2.label'),
                                                            'placeholder'   => __('backend::projects.fields.opportunity_image2.placeholder'),
                                                            'help'          => __('backend::projects.fields.opportunity_image2.help', [
                                                            ...
                                                            'required'      => false,
                                                            'browse'        => __('backend::projects.fields.opportunity_image2.add_text'),
                                                            'remove'        => __('backend::projects.fields.opportunity_image2.remove_text'),
                                                            'width'         => '349px',
                                                            'height'        => '250px',
                                                        ]
                                                    ])
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    ...
                                                    {{-- @include('cms::components.inputs.dateTimePicker', [
                                                        'options' => [
                                                            'name'          => 'deliver_date',
                                                            'label'         => __('backend::opportunity.fields.deliver_date.label'),
                                                            'placeholder'   => __('backend::opportunity.fields.deliver_date.placeholder'),
                                                            'help'          => __('backend::opportunity.fields.deliver_date.help'),
