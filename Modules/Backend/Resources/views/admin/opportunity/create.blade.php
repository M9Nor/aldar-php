...
@section('subheader')
    @component('cms::includes.subheader', [
        'options' => [
            'title' =>  __('backend::opportunity.create_new_opportunity'),
            'items' => [
                [
                    'label' => __('backend::opportunity.title'),
                    'link'  => route('OpportunityController@index')
                ], [
                    'label' => __('backend::opportunity.create_new_opportunity'),
                    'link'  => 'javascript:;'
                ]
            ]
        ]
...
@section('content')
    <div class="kt-portlet kt-portlet--tabs kt-portlet--last kt-portlet--responsive-mobile" id="kt_page_portlet">
        ...
        <div class="kt-portlet__body">
            <div class="row">
                <div class="col-md-12">
                    <form onsubmit="onFormSubmit(event);" class="kt-form" id="addNewForm" action="{{ route('OpportunityController@store') }}" method="POST" enctype="multipart/form-data">
                        <div class="tab-content">
                            ...
                            <div class="tab-pane active" id="add_tab_1" role="tabpanel">
                                @include('backend::admin.opportunity.sections.main')
                            </div>
                            <div class="tab-pane" id="add_tab_2" role="tabpanel">
                                @include('backend::admin.opportunity.sections.details')
                            </div>
                            <div class="tab-pane" id="add_tab_3" role="tabpanel">
                                @include('backend::admin.opportunity.sections.location')
                            </div>
                            <div class="tab-pane" id="add_tab_4" role="tabpanel">
                                @include('backend::admin.opportunity.sections.media')
                            </div>
                           <!--  <div class="tab-pane" id="add_tab_5" role="tabpanel">
                                @include('backend::admin.opportunity.sections.service')
                            </div>
                            <div class="tab-pane" id="add_tab_6" role="tabpanel">
                                @include('backend::admin.opportunity.sections.pay')
                            </div> -->
                            <div class="tab-pane" id="add_tab_7" role="tabpanel">
                                @include('backend::admin.opportunity.sections.price')
                            </div>
                        </div>
                    </form>
                </div>
