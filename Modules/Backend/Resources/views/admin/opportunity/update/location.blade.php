                                ...
                                {{-- <div class="col-md-12">
                                    @include('cms::components.inputs.tinymce', [
                                        'options' => [
                                            ...
                                            'name'              => 'details_area',
                                            'type'              => 'text',
                                            'label'             => __('backend::opportunity.fields.details_area.label'),
                                            'placeholder'       => __('backend::opportunity.fields.details_area.placeholder'),
                                            'help'              => __('backend::opportunity.fields.details_area.help'),
