                    ...
                    <form onsubmit="onFormSubmit(event);" class="kt-form" id="addNewForm" action="{{ route('ProjectController@store') }}" method="POST" enctype="multipart/form-data">
                        <div class="tab-content">
                            ...
                            <div class="tab-pane" id="add_tab_3" role="tabpanel">
                                @include('backend::admin.projects.sections.information')
                            </div>
...
@endsection
@push('scripts')
{{-- <script src="{{ Module::asset('cms:metronic/jQuery.tagify.min.js') }}"></script> --}}
{{-- <script src="{{ Module::asset('cms:metronic/js/pages/crud/forms/widgets/tagify.js') }}"></script> --}}
{{-- <script src="{{ Module::asset('cms:metronic/tagify.min.js') }}"></script> --}}
<script>
