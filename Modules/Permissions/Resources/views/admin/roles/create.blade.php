...
@section('subheader')
    @component('cms::includes.subheader', [
        'options' => [
            'title' =>  __('permissions::roles.create_new'),
            'items' => [
                [
                    'label' => __('permissions::roles.title'),
                    'link'  => route('RoleController@index')
                ], [
                    'label' => __('permissions::roles.create_new'),
                    'link'  => 'javascript:;'
                ]
            ]
        ]
        ...
        <div class="btn-group" role="group" aria-label="...">
            ...
            <div class="btn-group">
                ...
                <button type="button" class="btn btn-success btn-bold dropdown-toggle dropdown-toggle-split" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                </button>
                <div class="dropdown-menu dropdown-menu-{{ $langDirection == 'rtl' ? 'left' : 'right' }}">
                    <ul class="kt-nav">
                        <li class="kt-nav__item">
                            <a href="javascript:;" onclick="getElementById('redirectType').value = 'save_and_add_new';" class="submit_form kt-nav__link">
                        ...
                        <li class="kt-nav__item">
                            <a href="javascript:;" onclick="getElementById('redirectType').value = 'save_and_exit';" class="submit_form kt-nav__link">
...
@section('content')
    <form onsubmit="onFormSubmit(event);" class="kt-form kt-form--label-right" id="addNewForm" action="{{ route('RoleController@store') }}" method="POST" enctype="multipart/form-data">
        @csrf
        <input type="hidden" id="redirectType" name="redirect_type" value="save_and_exit">
        <div class="row">
                ...
                <div class="accordion accordion-solid accordion-panel accordion-toggle-svg" id="accordion">
                    ...
                    <div class="card">
                        ...
                        <div class="card-header" id="header_{{ $group->id }}">
                            <div class="card-title " data-toggle="collapse" data-target="#card__id_{{ $group->id }}" aria-expanded="" aria-controls="card__id_{{ $group->id }}">
                        ...
                        <div id="card__id_{{ $group->id }}" class="collapse  aria-labelledby="header_{{ $group->id }}" style="">
                            <div class="card-body">
