...
{
    public function addCategoriesAndFilters(){
        $turkeyCategory                       = CrudModel::firstOrNew([
            'type' => 'turkey_real_estate',
            'slug' => Str::slug('turkey_real_estate')
        ]);
        $turkeyCategory->parent_id            = null;
        $turkeyCategory->{'title:ar'}         = 'عقارات تركيا';
        $turkeyCategory->{'title:en'}         = 'Turkey real estate';
        $turkeyCategory->{'description:ar'}   = '';
        $turkeyCategory->{'description:en'}   = '';
        $turkeyCategory->{'brief:ar'}         = '';
        $turkeyCategory->{'brief:en'}         = '';
        $turkeyCategory->save();

        $filter_tr                       = Content::firstOrNew([
            'type' => 'filters',
            'slug' => Str::slug('apartments-for-sale-in-turkey')
        ]);
        $filter_tr->{'title:ar'}         = 'شقق للبيع في تركيا';
        $filter_tr->{'title:en'}         = 'Apartments for sale in Turkey';
        $filter_tr->{'description:ar'}   = '';
        $filter_tr->{'description:en'}   = '';
        $filter_tr->{'brief:ar'}         = '';
        $filter_tr->{'brief:en'}         = '';
        $filter_tr->save();
        $filter_tr->categories()->sync([
            $turkeyCategory->id
        ]);

        $filter_tr                       = Content::firstOrNew([
            'type' => 'filters',
            'slug' => Str::slug('installments-apartments-for-sale-in-turkey')
        ]);
        $filter_tr->{'title:ar'}         = 'شقق اقساط للبيع في تركيا';
        $filter_tr->{'title:en'}         = 'Installments apartments for sale in Turkey';
        $filter_tr->{'description:ar'}   = '';
        $filter_tr->{'description:en'}   = '';
        $filter_tr->{'brief:ar'}         = '';
        $filter_tr->{'brief:en'}         = '';
        ...
        $filter_tr                       = Content::firstOrNew([
            'type' => 'filters',
            'slug' => Str::slug('sea-view-apartments-for-sale-in-turkey')
        ]);
        $filter_tr->{'title:ar'}         = 'شقق اطلالة بحر للبيع في تركيا';
        $filter_tr->{'title:en'}         = 'Sea view apartments for sale in Turkey';
        $filter_tr->{'description:ar'}   = '';
        $filter_tr->{'description:en'}   = '';
        $filter_tr->{'brief:ar'}         = '';
        $filter_tr->{'brief:en'}         = '';
        ...
        $filter_tr                       = Content::firstOrNew([
            'type' => 'filters',
            'slug' => Str::slug('cheap-apartments-for-sale-in-turkey')
        ]);
        $filter_tr->{'title:ar'}         = 'شقق رخيصة للبيع في تركيا';
        $filter_tr->{'title:en'}         = 'Cheap apartments for sale in Turkey';
        $filter_tr->{'description:ar'}   = '';
        $filter_tr->{'description:en'}   = '';
        $filter_tr->{'brief:ar'}         = '';
        $filter_tr->{'brief:en'}         = '';
        ...
        $filter_tr                       = Content::firstOrNew([
            'type' => 'filters',
            'slug' => Str::slug('shops-for-sale-in-turkey')
        ]);
        $filter_tr->{'title:ar'}         = 'محلات للبيع في تركيا';
        $filter_tr->{'title:en'}         = 'Shops for sale in Turkey';
        $filter_tr->{'description:ar'}   = '';
        $filter_tr->{'description:en'}   = '';
        $filter_tr->{'brief:ar'}         = '';
        $filter_tr->{'brief:en'}         = '';
        ...
        $filter_tr                       = Content::firstOrNew([
            'type' => 'filters',
            'slug' => Str::slug('villas-for-sale-in-turkey')
        ]);
        $filter_tr->{'title:ar'}         = 'فلل للبيع في تركيا';
        $filter_tr->{'title:en'}         = 'Villas for sale in Turkey';
        $filter_tr->{'description:ar'}   = '';
        $filter_tr->{'description:en'}   = '';
        $filter_tr->{'brief:ar'}         = '';
        $filter_tr->{'brief:en'}         = '';
        ...
        $filter_tr                       = Content::firstOrNew([
            'type' => 'filters',
            'slug' => Str::slug('cheap-villas-for-sale-in-turkey')
        ]);
        $filter_tr->{'title:ar'}         = 'فلل رخيصة للبيع في تركيا';
        $filter_tr->{'title:en'}         = 'Cheap villas for sale in Turkey';
        $filter_tr->{'description:ar'}   = '';
        $filter_tr->{'description:en'}   = '';
        $filter_tr->{'brief:ar'}         = '';
        $filter_tr->{'brief:en'}         = '';
        ...
        $filter_tr                       = Content::firstOrNew([
            'type' => 'filters',
            'slug' => Str::slug('sea-view-villas-for-sale-in-turkey')
        ]);
        $filter_tr->{'title:ar'}         = 'فلل اطلالة بحر للبيع في تركيا';
        $filter_tr->{'title:en'}         = 'Sea view villas for sale in Turkey';
        $filter_tr->{'description:ar'}   = '';
        $filter_tr->{'description:en'}   = '';
        $filter_tr->{'brief:ar'}         = '';
        $filter_tr->{'brief:en'}         = '';
        ...
        $istanbulCategory                       = CrudModel::firstOrNew([
            'type' => 'istanbul_real_estate',
            'slug' => Str::slug('istanbul_real_estate')
        ]);
        $istanbulCategory->parent_id            = null;
        $istanbulCategory->{'title:ar'}         = 'عقارات اسطنبول';
        $istanbulCategory->{'title:en'}         = 'Istanbul real estate';
        $istanbulCategory->{'description:ar'}   = '';
        $istanbulCategory->{'description:en'}   = '';
        $istanbulCategory->{'brief:ar'}         = '';
        $istanbulCategory->{'brief:en'}         = '';
        $istanbulCategory->save();


        $filter_en                       = Content::firstOrNew([
            'type' => 'filters',
            'slug' => Str::slug('installments-apartments-for-sale-in-istanbul')
        ]);
        $filter_en->{'title:ar'}         = 'شقق اقساط للبيع في اسطنبول';
        $filter_en->{'title:en'}         = 'Installments apartments for sale in Istanbul';
        $filter_en->{'description:ar'}   = '';
        $filter_en->{'description:en'}   = '';
        $filter_en->{'brief:ar'}         = '';
        $filter_en->{'brief:en'}         = '';
        $filter_en->save();
        $filter_en->categories()->sync([
            $istanbulCategory->id
        ]);
        $filter_en                       = Content::firstOrNew([
            'type' => 'filters',
            'slug' => Str::slug('cheap-villas-for-sale-in-istanbul')
        ]);
        $filter_en->{'title:ar'}         = 'فلل رخيصة للبيع في اسطنبول';
        $filter_en->{'title:en'}         = 'Cheap villas for sale in Istanbul';
        $filter_en->{'description:ar'}   = '';
        $filter_en->{'description:en'}   = '';
        $filter_en->{'brief:ar'}         = '';
        $filter_en->{'brief:en'}         = '';
        ...
        $filter_en                       = Content::firstOrNew([
            'type' => 'filters',
            'slug' => Str::slug('sea-view-villas-for-sale-in-istanbul')
        ]);
        $filter_en->{'title:ar'}         = 'فلل اطلالة بحر للبيع في اسطنبول';
        $filter_en->{'title:en'}         = 'Sea view villas for sale in Istanbul';
        $filter_en->{'description:ar'}   = '';
        $filter_en->{'description:en'}   = '';
        $filter_en->{'brief:ar'}         = '';
        $filter_en->{'brief:en'}         = '';
        ...
        $filter_en                       = Content::firstOrNew([
            'type' => 'filters',
            'slug' => Str::slug('apartments-for-sale-in-istanbul')
        ]);
        $filter_en->{'title:ar'}         = 'شقق للبيع في اسطنبول';
        $filter_en->{'title:en'}         = 'Apartments for sale in Istanbul';
        $filter_en->{'description:ar'}   = '';
        $filter_en->{'description:en'}   = '';
        $filter_en->{'brief:ar'}         = '';
        $filter_en->{'brief:en'}         = '';
