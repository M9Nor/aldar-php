...
@section('content')
    <div class="kt-portlet kt-portlet--tabs kt-portlet--last kt-portlet--responsive-mobile" id="kt_page_portlet">
        ...
        <div class="kt-portlet__body">
            <div class="row">
                <div class="col-md-12">
                    <form onsubmit="onFormSubmit(event);" class="kt-form" id="addNewForm" action="{{ route('LandingPageController@store') }}" method="POST" enctype="multipart/form-data">
                        <div class="tab-content">
                            ...
                            <div class="tab-pane active" id="add_tab_1" role="tabpanel">
                                @include('cms::admin.landingpages.create.meta')
                            </div>
                            <div class="tab-pane" id="add_tab_2" role="tabpanel">
                                @include('cms::admin.landingpages.create.header')
                            </div>
                            <div class="tab-pane" id="add_tab_3" role="tabpanel">
                                @include('cms::admin.landingpages.create.subject_text')
                            </div>
                            <div class="tab-pane" id="add_tab_4" role="tabpanel">
                                @include('cms::admin.landingpages.create.projects')
                            </div>
                            <div class="tab-pane" id="add_tab_5" role="tabpanel">
                                @include('cms::admin.landingpages.create.blogs')
                            </div>
                            <div class="tab-pane" id="add_tab_6" role="tabpanel">
                                @include('cms::admin.landingpages.create.services')
                            </div>
                            <div class="tab-pane" id="add_tab_7" role="tabpanel">
                                @include('cms::admin.landingpages.create.videos')
                            </div>
                            <div class="tab-pane" id="add_tab_8" role="tabpanel">
                                @include('cms::admin.landingpages.create.subject_text2')
                            </div>
                            <div class="tab-pane" id="add_tab_9" role="tabpanel">
                                @include('cms::admin.landingpages.create.footer')
                            </div>
                            <div class="tab-pane" id="add_tab_10" role="tabpanel">
                                @include('cms::admin.landingpages.create.timeline')
                            </div>
                        </div>
                    </form>
                </div>
