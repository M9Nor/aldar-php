                                        ...
                                        <div class="tab-pane {{ $loop->first ? 'active' : '' }}" id="tab_subject_text2_{{ $locale }}" role="tabpanel">
                                            @include('cms::components.inputs.text', [
                                                'options' => [
                                                    ...
                                                    'value'         => old('subject_text2_h2_' . $locale,$model->translate($locale) == NULL ? NULL : $model->translate($locale)->subject_text2_h2),
                                                    'required'      => false,
                                                    'inline'        => false,
                                            ...
                                            @include('cms::components.inputs.text', [
                                                'options' => [
                                                    ...
                                                    'value'         => old('subject_text2_h3_' . $locale,$model->translate($locale) == NULL ? NULL : $model->translate($locale)->subject_text2_h3),
                                                    'required'      => false,
                                                    'inline'        => false,
                                                    'direction'     => LaravelLocalization::getCurrentLocaleDirection()
                                                ]
                                                ...
                                                <div class="col-md-12">
                                                    ...
                                                    @include('cms::components.inputs.tinymce', [
                                                        'options' => [
                                                            ...
                                                            'value'             => old('subject_text2_desc_' . $locale,$model->translate($locale) == NULL ? NULL : $model->translate($locale)->subject_text2_desc),
                                                            'rows'              => 6,
                                                            'base_script'       => false,
                                                            'required'          => false,
                                                        ]
                                    ...
                                    <div class="col-md-6">
                                        @include('cms::components.inputs.select', [
                                            'options' => [
                                                ...
                                                'selected'      => old('subject_text2',$model->subject_text2),
                                    ...
                                    <div class="col-md-6">
                                        @include('cms::components.inputs.text', [
                                            'options' => [
                                                ...
                                                'value'             => old('subject_text2_background',$model->subject_text2_background),
                                                'required'          => false,
                                                'inline'            => false,
                                                'maxlength'         => 191,
