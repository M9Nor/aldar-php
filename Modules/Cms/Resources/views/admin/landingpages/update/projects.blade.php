                                    ...
                                    <div class="col-md-12">
                                        @include('cms::components.inputs.select', [
                                            'options' => [
                                                ...
                                                'name'          => 'projects',
                                                'type'          => 'text',
                                                'label'         => __('cms::landing_page.fields.projects.label'),
                                                'placeholder'   => __('cms::landing_page.fields.projects.placeholder'),
                                                'help'          => __('cms::landing_page.fields.projects.help'),
                                                'data'          => [
                                                    [
                                                ...
                                                'selected'      => old('projects',$model->projects),
                                    ...
                                    <div class="col-md-12">
                                        @include('cms::components.inputs.select', [
                                            'options' => [
                                                'id'                => 'projects_ids',
                                                'name'              => 'projects_ids[]',
                                                'label'             => __('cms::landing_page.fields.projects_ids.label'),
                                                'placeholder'       => __('cms::landing_page.fields.projects_ids.placeholder'),
                                                'help'              => __('cms::landing_page.fields.projects_ids.help'),
                                                'data'              => $projects->get(),
                                                'selected'          => old('projects',$selected_projects),
