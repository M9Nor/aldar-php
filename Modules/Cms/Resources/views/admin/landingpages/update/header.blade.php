                                        ...
                                        <div class="tab-pane {{ $loop->first ? 'active' : '' }}" id="tab_header_{{ $locale }}" role="tabpanel">
                                            @include('cms::components.inputs.image', [
                                                'options' => [
                                                    ...
                                                    'default'       => old('header_logo_'.$locale,$model->translate($locale) == NULL ? (new Modules\Cms\Entities\LandingPageTranslation)->headerLogo('400x200') : $model->translate($locale)->headerLogo('400x200') ),
                                                    'required'      => true,
                                                    // 'inline'        => '3:9',
                                            ...
                                            @include('cms::components.inputs.image', [
                                                'options' => [
                                                    ...
                                                    'default'       => old('header_background_'.$locale,$model->translate($locale) == NULL ? (new Modules\Cms\Entities\LandingPageTranslation)->headerBackground('400x200') : $model->translate($locale)->headerBackground('400x200') ),
                                                    'required'      => true,
                                                    // 'inline'        => '3:9',
                                                    'browse'        => __('cms::cruds.contents.image.add_text'),
                                                    'remove'        => __('cms::cruds.contents.image.remove_text'),
                                            ...
                                            @include('cms::components.inputs.text', [
                                                'options' => [
                                                    ...
                                                    'value'         => old('header_h1_' . $locale,$model->translate($locale) == NULL ? NULL : $model->translate($locale)->header_h1),
                                                    'required'      => false,
                                                    'inline'        => false,
                                            ...
                                            @include('cms::components.inputs.text', [
                                                'options' => [
                                                    ...
                                                    'value'         => old('header_h2_' . $locale,$model->translate($locale) == NULL ? NULL : $model->translate($locale)->header_h2),
                                                    'required'      => false,
                                                    'inline'        => false,
                                                    'direction'     => LaravelLocalization::getCurrentLocaleDirection()
                                                ]
                                            ...
                                            @include('cms::components.inputs.text', [
                                                'options' => [
                                                    ...
                                                    'value'         => old('header_h1_above_' . $locale,$model->translate($locale) == NULL ? NULL : $model->translate($locale)->header_h1_above),
                                                    'required'      => false,
                                                    'inline'        => false,
                                                    'direction'     => LaravelLocalization::getCurrentLocaleDirection()
                                                ]
                                            ...
                                            @include('cms::components.inputs.text', [
                                                'options' => [
                                                    ...
                                                    'value'         => old('header_h2_above_' . $locale,$model->translate($locale) == NULL ? NULL : $model->translate($locale)->header_h2_above),
                                                    'required'      => false,
                                                    'inline'        => false,
                                                    'direction'     => LaravelLocalization::getCurrentLocaleDirection()
                                                ]
                                            ...
                                            @include('cms::components.inputs.text', [
                                                'options' => [
                                                    ...
                                                    'value'         => old('header_h1_under_' . $locale,$model->translate($locale) == NULL ? NULL : $model->translate($locale)->header_h1_under),
                                                    'required'      => false,
                                                    'inline'        => false,
                                                    'direction'     => LaravelLocalization::getCurrentLocaleDirection()
                                                ]
                                            ...
                                            @include('cms::components.inputs.text', [
                                                'options' => [
                                                    ...
                                                    'value'         => old('header_h2_under_' . $locale,$model->translate($locale) == NULL ? NULL : $model->translate($locale)->header_h2_under),
                                                    'required'      => false,
                                                    'inline'        => false,
                                                    'direction'     => LaravelLocalization::getCurrentLocaleDirection()
                                                ]
                                    ...
                                    <div class="col-md-6">
                                        @include('cms::components.inputs.select', [
                                            'options' => [
                                                ...
                                                'selected'      => old('form_direction',$model->form_direction),
                                                'value'         => function($data, $key, $value){ return $value['value']; },
                                                'text'          => function($data, $key, $value){ return $value['text']; },
                                                'select'        => function($data, $selected, $key, $value){ return $selected == $value['value']; },
                                                'required'      => false,
