                                        ...
                                        <div class="tab-pane {{ $loop->first ? 'active' : '' }}" id="tab_videos_{{ $locale }}" role="tabpanel">
                                            @include('cms::components.inputs.text', [
                                                'options' => [
                                                    ...
                                                    'value'         => old('videos_title_' . $locale,$model->translate($locale) == NULL ? NULL : $model->translate($locale)->videos_title),
                                                    'required'      => false,
                                                    'inline'        => false,
                                    ...
                                    <div class="col-md-6">
                                        @include('cms::components.inputs.select', [
                                            'options' => [
                                                ...
                                                'selected'      => old('videos',$model->videos),
                                    ...
                                    <div class="col-md-6">
                                        @include('cms::components.inputs.text', [
                                            'options' => [
                                                ...
                                                'value'             => old('videos_link',$model->videos_link),
                                                'required'          => false,
                                                'inline'            => false,
                                                'maxlength'         => 191,
