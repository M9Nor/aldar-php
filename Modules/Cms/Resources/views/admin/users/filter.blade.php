...
@push('filter.form')
    <div id="filter" class="kt-section" style="display: none;">
        <div class="kt-section__title">
            {{ __('cms::users.filter.title') }}
        </div>
        <div class="kt-section__desc">
            {{ __('cms::users.filter.description') }}
        </div>
                    ...
                    <div class="col-lg-3 kt-margin-b-10-tablet-and-mobile">
                        @include('cms::components.inputs.text', [
                            'options' => [
                                'name'          => 'name',
                                'type'          => 'text',
                                'label'         => __('cms::users.fields.name.label'),
                                'placeholder'   => __('cms::users.fields.name.placeholder'),
                                'help'          => __('cms::users.fields.name.help'),
                                'value'         => old('name'),
                                'required'      => false
                            ]
                        ])
                    ...
                    <div class="col-lg-3 kt-margin-b-10-tablet-and-mobile">
                        @include('cms::components.inputs.select', [
                            'options' => [
                                'nullable'      => true,
                                'name'          => 'status',
                                'label'         => __('cms::users.fields.status.label'),
                                'help'          => __('cms::users.fields.status.help'),
                                'data'          => $statuses,
                                'selected'      => old('status'),
                    ...
                    {{-- <div class="col-lg-3 kt-margin-b-10-tablet-and-mobile">
                        @include('cms::components.inputs.select', [
                            'options' => [
                                'nullable'      => true,
                                'name'          => 'type',
                                'label'         => __('cms::users.fields.type.label'),
                                'help'          => __('cms::users.fields.type.help'),
                                'data'          => $types,
                                'selected'      => old('type'),
