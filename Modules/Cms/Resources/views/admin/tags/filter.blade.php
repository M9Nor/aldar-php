                    ...
                    <div class="col-lg-4 kt-margin-b-10-tablet-and-mobile">
                        @include('cms::components.inputs.select', [
                            'options' => [
                                ...
                                'name'          => 'language',
                                'type'          => 'text',
                                'label'         => __('cms::areas.tags.fields.language.label'),
                                'placeholder'   => __('cms::areas.tags.fields.language.placeholder'),
                                'help'          => __('cms::areas.tags.fields.language.help'),
                                'data'          => [
                                    [
                                        'text'      => __('cms::areas.all'),
                                        'value'     => '',
                                    ],
                                    [
                                        'text'      => 'Arabic',
