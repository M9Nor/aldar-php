...
@section('content')
    <form onsubmit="onFormSubmit(event);" class="kt-form kt-form--label-right" id="addNewForm" action="{{ route('TagController@update',['model' => $model->id]) }}" method="POST">
        @csrf
                                            ...
                                            <div class="col-sm-12">
                                                @include('cms::components.inputs.image', [
                                                    'options' => [
                                                        ...
                                                        'default'       => old('image_'.$locale, $model->translate($locale) == NULL ? (new Modules\Cms\Entities\TagTranslation)->getImage('400x400') : $model->translate($locale)->getImage('400x400')),
                                                        'required'      => true,
                                                ...
                                                @include('cms::components.inputs.text', [
                                                    'options' => [
                                                        ...
                                                        'name'          => 'text_'.$locale,
                                                        'type'          => 'text',
                                                        'label'         => __('cms::areas.fields.text.label'),
                                                        'placeholder'   => __('cms::areas.fields.text.placeholder'),
                                                        'help'          => __('cms::areas.fields.text.help'),
                                                        'value'         => old('text_'.$locale,$model->translate($locale) == NULL ? NULL : $model->translate($locale)->text),
                                                        'required'      => true,
                                                    ]
                                                ])
                                            </div>
