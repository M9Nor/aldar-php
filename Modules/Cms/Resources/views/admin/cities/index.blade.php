...
@section('subheader')
    @component('cms::includes.subheader', [
        ...
        <form id="massDeleteForm" onsubmit="onFormSubmit(event);" method="POST" action="{{ route('CityController@massDestroy') }}" style="display: none;">
        ...
        <form id="massRestoreForm" onsubmit="onFormSubmit(event);" method="POST" action="{{ route('CityController@massRestore') }}" style="display: none;">
            <input type="hidden" name="_token" value="{{ csrf_token() }}">
            <input type="hidden" name="ids">
        </form>
        ...
        @if(auth()->user()->can('create', City::class))
            <a href="{{ route('CityController@create') }}" class="btn btn-outline-success btn-sm btn-icon btn-icon-md btn-elevate datatable-custom-tools" data-toggle="kt-tooltip" data-placement="right" title="" data-original-title="{{ __('cms::global.add_new') }}">
        ...
        <table class="table table-bordered table-striped table-hover table-checkable" id="datatable">
            <thead>
                <tr class="cms-font">
                    ...
                    <th>{{ __('cms::areas.datatable.city') }}</th>
...
@if(auth()->user()->can('viewDeleted', City::class))
