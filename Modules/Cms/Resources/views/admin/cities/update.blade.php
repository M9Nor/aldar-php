...
@section('subheader')
    @component('cms::includes.subheader', [
        'options' => [
            'title' => __('cms::areas.edit_city'),
            'items' => [
                [
                    'label' => __('cms::areas.cities'),
                    'link'  => route('CityController@index')
                ], [
                    'label' =>__('cms::areas.edit_city'),
                    'link'  => 'javascript:;'
                ]
            ]
        ]
...
@section('content')
    <form onsubmit="onFormSubmit(event);" class="kt-form kt-form--label-right" id="addNewForm" action="{{ route('CityController@update',['model' => $model->id]) }}" method="POST" enctype="multipart/form-data">
        @csrf
                                            ...
                                            <div class="col-md-12">
                                                @include('cms::components.inputs.image', [
                                                    'options' => [
                                                        ...
                                                        'default'       => old('image_'.$locale, $model->getTranslatedImage('500x375')),
                                                        'required'      => false,
