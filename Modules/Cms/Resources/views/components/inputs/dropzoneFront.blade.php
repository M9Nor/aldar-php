@if(isset($options))
    @php
        $opt = array_merge([
            ...
            'name'                  => 'attachments',
            'max_files'             => 50,
            'url'                   => route('PropertyController@store'),
            'remove_url'            => route('PropertyController@destroy'),
            'label'                 => 'Text Input',
            'placeholder'           => null,
            'help'                  => null,
            'required'              => false,
            'validation_rules'      => 'required|file|max:2048|mimes:jpeg,jpg,png',
            'sub_folder'            => null,
            'attachments'           => [],
            'error_bag'             => null,
            'model'                 => [],
        ...
        <script>
            var model = {!! json_encode($opt['model']) !!},
                ...
                previewTemplate: `<div class="dz-preview dz-file-preview">
                    ...
                    <inpu style="display:none"t type="text" name="" class="form-control form-control-sm my-2 dz-title" placeholder="ادخل العنوان">
                    <textarea style="display:none" name="" class="form-control form-control-sm my-2 dz-description" placeholder="ادخل الوصف"></textarea>
                </div>`,
                init: function() {
                            ...
                            if(result.value) {
                                ...
                                $.ajax({
                                    ...
                                    success: function (response){
                                        ...
                                        showMessage("{{trans('frontend::main.image_deleted')}}",true);
                                    ...
                                    error: function(e) {
                                        ...
                                        showMessage("{{trans('frontend::main.some_errors_occurred')}}",false);
                                    }
                                });
                ...
                success: function(file, response) {
                    ...
                    // showMessage("{{trans('frontend::main.image_added')}}",false);
