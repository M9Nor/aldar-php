...
@section('subheader')
    @component('cms::includes.subheader', [
        'options' => [
            'title' =>  __('cms::cruds.config.create'),
            'items' => [
                [
        ...
        @slot('toolbar')
            ...
            <div class="btn-group">
                <a href="javascript:;" data-redirect-url="{{ route('ConfigController@index') }}" class="submit_form btn btn-success btn-bold">
...
@section('content')
    <form onsubmit="onFormSubmit(event);" class="kt-form kt-form--label-right" id="addNewForm" action="{{ route('ConfigController@store') }}" method="POST">
        @csrf
                                    ...
                                    <div class="col-sm-6">
                                        @include('cms::components.inputs.select', [
                                            'options' => [
                                                ...
                                                'selected'      => old('config_validate',1),
                                                'value'         => function($data, $key, $value){ return $value['value']; },
                                                'text'          => function($data, $key, $value){ return $value['text']; },
                                                'select'        => function($data, $selected, $key, $value){ return $selected == $value['value']; },
                                                'required'      => true,
                                    ...
                                    <div class="col-sm-6">
                                        @include('cms::components.inputs.select', [
                                            'options' => [
                                                ...
                                                'selected'      => old('has_additional_info',0),
                                                'value'         => function($data, $key, $value){ return $value['value']; },
                                                'text'          => function($data, $key, $value){ return $value['text']; },
                                                'select'        => function($data, $selected, $key, $value){ return $selected == $value['value']; },
                                                'required'      => true,
