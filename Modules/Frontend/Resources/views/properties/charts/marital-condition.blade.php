<div id="maritalConditionChart" style="height: 300px; width: 100%;"></div>
...
<script>
    am4core.ready(function() {
        ...
        var chart = am4core.create("maritalConditionChart", am4charts.PieChart);
        ...
        //     title.text = "{{__('cms::areas.custom_fields.demographic_data.marital_condition.title')}}";
        //     title.fontSize = 14;
        //     title.align = "center";
