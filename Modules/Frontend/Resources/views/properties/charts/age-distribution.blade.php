<div id="ageDistributionChart" style="height: 300px; width: 100%;"></div>
...
<script>
    am4core.ready(function() {
        ...
        var chart = am4core.create("ageDistributionChart", am4charts.PieChart);
        ...
        //     title.text = "{{__('cms::areas.custom_fields.demographic_data.age_distribution.title')}}";
        //     title.fontSize = 14;
        //     title.align = "center";
