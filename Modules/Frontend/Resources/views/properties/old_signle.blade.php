                            ...
                            <div class="pro-wrapper">
                                <div class="detail-wrapper-body">
                                    <div class="listing-title-bar">
                                        <div>
                                            <span class="mrg-l-5 category-tag">{{ $category->translateOrFirst()->title }}</span>
                                        </div>
                                        <h3>
                                        ...
                                        <div class="mt-0">
                                            <a href="javascript:;" class="listing-address">
                                                <i class="fa fa-map-marker pr-2 ti-location-pin mrg-r-5"></i>{{$addressDetails}}
                                            </a>
                                        </div>
                                    </div>
                                </div>
                                ...
                                @if($model->attachments->isNotEmpty())
                                    ...
                                    @foreach ($model->attachments as $key => $attachment)
                                        <div class="item carousel-item {{$key == 0 ? 'active' : ''}}" data-slide-number="{{$key}}">
                                            <img class="lazy" src="{{$default}}" data-src="{{$attachment->getUid('1920x1280')}}" 
                                            class="img-fluid" alt="{{$attachment->title . (!is_null($attachment->description) ? ', ' . $attachment->description : '') }}">
                                        </div>
                                    @endforeach
                            ...
                            <ul class="carousel-indicators smail-listing list-inline nav nav-justified">
                                @foreach ($model->attachments as $key => $attachment)
                                    <li class="list-inline-item {{$key == 0 ? 'active' : ''}}">
                                        <a id="carousel-selector-0" class="selected" data-slide-to="{{$key}}" data-target="#listingDetailsSlider">
                                            <img src="{{$default}}" data-src="{{$attachment->getUid("192x128")}}" 
                                                class="img-fluid lazy" alt="{{$attachment->title . (!is_null($attachment->description) ? ', ' . $attachment->description : '') }}">
                                        </a>
                                    </li>
                                @endforeach
                            </ul>
