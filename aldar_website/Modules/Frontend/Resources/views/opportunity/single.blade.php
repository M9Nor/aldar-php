        ...
        <section class="single-proper blog details single-project">
            <div class="custom-container">
                ...
                <div class="row">
                          ...
                          <!--  <a class="additional_details active" data-scroll href="#additional_details">{{__('frontend::properties.details')}}</a>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                   ...
                                   <div class="mt-3"> <span class="roi-box">{{__("frontend::main.roi")}} {{$model->roi}}%</span> </div>
                    ...
                    @includeWhen(isset($recentProjectsOpp[app()->getLocale()]),'frontend::includes.recent_opp')
